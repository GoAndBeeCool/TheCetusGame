 ...
 * A class that when given values or byte arrays will...
 * return a byte array after converting the value into bytes...
 * or return the desired primitive data type from the byte array.
 * 
 * Code was given by Kim.
 */
package model;
